...
export function OverrideLeaderModal() {
  const { activeModal, targetSequencerId, closeModal, overrideLeader, loading, error } = useActionStore();
          ...
          <div className="rounded-md bg-red-50 dark:bg-red-900/20 p-4">
            <div className="flex">
              ...
              <div className="text-sm text-red-800 dark:text-red-200">
                ...
                <p className="mb-2">This operation can cause a split-brain scenario where multiple nodes believe they are the leader.</p>
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="text-sm text-muted-foreground mt-1">
                ...
                <p>Is Leader: <span className="font-medium text-foreground">{sequencer.conductor_leader ? 'Yes' : 'No'}</span></p>
                <p>Is Active: <span className="font-medium text-foreground">{sequencer.conductor_active ? 'Yes' : 'No'}</span></p>
              </div>
            </div>
